...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"alter.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alter.showAlert)('success', 'Logged in successfully!');
          ...
          case 9:
            ...
            (0, _alter.showAlert)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            (0, _alter.showAlert)('error', 'Error logging out!Try again');
...
},{"axios":"../../node_modules/axios/index.js","./alter":"alter.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieXVkaGFqaXQiLCJhIjoiY2tvZ3lmN3Z2MDV1dTJ3cm1teGtlcDM2eCJ9.qEZaWyw960HYtYkrP7a4Fw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.day, ":").concat(loc.description, "</p>")); //Extends map bounds to include currnet location
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alter.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully"));
            }
...
},{"axios":"../../node_modules/axios/index.js","./alter":"alter.js"}],"index.js":[function(require,module,exports) {
"use strict";
